...
hittable_list final_scene() {
    ...
    objects.add(make_shared<sphere>(point3(0, 150, 145), 50, make_shared<metal>(color(0.8, 0.8, 0.95), 1.0)));

    auto boundary = make_shared<sphere>(point3(360, 150, 145), 70, make_shared<dielectric>(1.5));
    objects.add(boundary);
    objects.add(make_shared<constant_medium>(boundary, 0.2,color(0.2, 0.4, 0.9)));
    boundary = make_shared<sphere>(point3(0, 0, 0), 5000, make_shared<dielectric>(1.5));
    objects.add(make_shared<constant_medium>(boundary, 0.0001, color(1, 1, 1)));    // シーン全体を覆う霧
...
int main() {
    ...
    switch(0) {
        ...
        case 8:
            world = final_scene();
            aspect_ratio = 1.0;
            image_width = 800, samples_per_pixel = 10000;
            background = color(0, 0, 0);
